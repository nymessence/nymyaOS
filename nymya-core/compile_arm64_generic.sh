...
# --------------------------
# Build for arm64 generic target
# --------------------------
echo -e "\n🚀 Starting build for ${TARGET}..."
IMAGE_NAME="nymya-build-env-arm64"
...
docker build --platform=${DOCKER_PLATFORM} -t ${IMAGE_NAME} -f Dockerfile.arm64 .
