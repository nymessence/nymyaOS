...
// Core system header for NymyaOS, the Nymya SDK, and libnymya.so
// Designed to be modular, portable, and testable on existing Linux systems
// Developers can install this system-wide and use:   #include <nymya/nymya.h>
...
#include <stdint.h>
#include <complex.h>  // _Complex double is okay in kernel with some caveats
...
#define swap(q1, q2)                   nymya_3313_swap(q1, q2)
